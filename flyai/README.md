...
<br class="ProseMirror-trailingBreak"></code></pre><h2>5. 실행 및 사용 방법</h2><h3>5.1. 로컬 통합 테스트 (Local Runner)</h3><p>서버를 띄우지 않고 <code>images/</code> 폴더의 이미지를 사용하여 전체 파이프라인을 검증할 수 있습니다.</p><pre><code># 로컬 러너 실행
